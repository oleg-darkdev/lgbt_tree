...
const element = {
	...
	shortDescription: `Queer is an identifier for individuals and/or the community of people who are not cisgender heterosexual It can be used instead of, or in addition to, other identifiers of sexual orientation, such as lesbian, bisexual, or gay. Queer can also refer to gender identity or gender expression, whether as a standalone term or part of another like genderqueer. The "Q" in LGBTQ2S+ and similar acronyms commonly means Queer. As a reclaimed word, it has been used in fights for LGBTQ2S+ rights and liberation as an inclusive and sometimes defiant term. PFLAG and GLAAD are two of the organizations that recommend only using it for people who self-identify as queer because it has varying meanings and is not universally accepted. In addition, the term may be used in preference to other identifiers by members, for a variety of reasons.`,
	number: 13
};
